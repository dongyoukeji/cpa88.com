...
<div class="admin_r_all" style="height: 477px;">
    <div class="admin_bg_all">
        ...
        <form action="/Admin/Admin/addhd" method="post" enctype="multipart/form-data">
            <div class="admin_bg_fb">
                    <span>
                        <em>管理员</em>
                        <input type="text" name="username" id="username" value="<?php echo ($admin["username"]); ?>" class="required" placeholder="管理员账号">
